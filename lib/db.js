...
const getSupabaseConnectionConfig = () => {
  ...
  // Use Transaction Pooler (port 6543, via pooler subdomain with IPv4)
  return {
    connectionString: `postgresql://postgres.${projectRef}:${password}@aws-1-us-east-1.pooler.supabase.com:6543/postgres`,
    ssl: { rejectUnauthorized: false },
  };
};
