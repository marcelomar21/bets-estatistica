...
- team_lastx_raw (obrigatório para cada equipe, usando seus team_id e escopo geral) para obter a forma recente diretamente do raw_payload.
Se a consulta não retornar dados, informe isso explicitamente e tente escopos alternativos se fizer sentido.
...
- Antes de escrever os blocos, use match_detail_raw (com match_id do contexto) e team_lastx_raw (com os team_id fornecidos) para capturar os dados brutos diretamente; registre explicitamente caso não haja retorno mesmo após consultar os dois times.
